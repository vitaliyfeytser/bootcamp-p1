...
$("#search-button").on("click", function (event) {
  ...
  if (searchByAuthor == "" && searchByBook == "") {
    ...
    if (searchByAuthor == "") {
      $("#popular-title").text("You searched for the following book title: " + searchByBook.toUpperCase());
    } else if (searchByBook == "") {
      $("#popular-title").text("You searched for the following author: " + searchByAuthor.toUpperCase());
      console.log("You searched for: ", searchByAuthor);
    } else {
      $("#popular-title").text("You searched for author " + searchByAuthor.toUpperCase() + " and book title " + searchByBook.toUpperCase() + ".");
    }
